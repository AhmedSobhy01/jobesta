...
ALTER TABLE "milestones" ADD FOREIGN KEY ("job_id", "freelancer_id") REFERENCES "proposals" ("job_id", "freelancer_id") ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "milestones" ADD FOREIGN KEY ("job_id", "freelancer_id", "order") REFERENCES "payments" ("job_id", "freelancer_id", "milestone_order") ON DELETE RESTRICT ON UPDATE CASCADE;
